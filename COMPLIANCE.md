...
The Ruby target implements **123 of 123** tests in
jsii's standard compliance suite (**100.00%**).
...
🟢 passing  🔴 failing  ⭕ not implemented  ⚪ not applicable

Suite read from `tools/jsii-compliance/suite.ts`.
